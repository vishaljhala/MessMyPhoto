	  ...
	  int*iErrCode,GlobalHelper &g_GH)
{
	...
	g_GH.cvSmoothProxy(pImgSource,pImgDest,CV_BILATERAL,5,0,fSigmaColor,fSigmaDist);
	g_GH.cvSmoothProxy(pImgDest,pImgSource,CV_BILATERAL,5,0,fSigmaColor,fSigmaDist);
